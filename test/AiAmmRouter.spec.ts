...
describe('AiAmmPool', () => {
  ...
  let pool0: MockTimeAiAmmPool
  let pool1: MockTimeAiAmmPool
  ...
  let swapTargetCallee: TestAiAmmCallee
  let swapTargetRouter: TestAiAmmRouter

...
describe('AiAmmFactory', () => {
  ...
  const fixture = async () => {
    ...
    return (await factoryFactory.deploy()) as AiAmmFactory
  }
  ...
  before('load pool bytecode', async () => {
    poolBytecode = (await ethers.getContractFactory('AiAmmPool')).bytecode
  })
  ...
  async function createAndCheckPool(
    ...
    const poolContractFactory = await ethers.getContractFactory('AiAmmPool')
